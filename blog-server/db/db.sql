...
-- ----------------------------
BEGIN;
INSERT INTO `tb_link` VALUES (1, 'Baiyu\'s blog', 'http://baixixi.xyz');
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_login_log` VALUES (33, 'baixixi', '127.0.0.1', '内网IP|0|0|内网IP|内网IP', '2019-09-22 15:57:29', 'Unknown -- Unknown');
COMMIT;
...
INSERT INTO `tb_tag` VALUES (2, '游记');
INSERT INTO `tb_tag` VALUES (4, '专题');
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` VALUES (1, 'baixixi', '5f9059b3feff398c928c7c1239e64975', 'afbe4bd05b55b755d2a3e7df3bc25586', 'http://img.api.tycoding.cn/1568958650973.jpeg', '兴趣使然的Coder', '银河街角，时光路口');
COMMIT;
